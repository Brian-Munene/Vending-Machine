...
from .views import CoinTypeViewset, CoinViewset, update_coin, purchase_product, show_available_coins, withdraw_coins
...
urlpatterns = [
    path('deposit/coin/<coin_id>', update_coin, name="updated_product"),
